...
public class User 
{
  ...
  public void removeRide() //added missing method
  {
      this.rides--;
  }
  public void removeDelivery() //added mssing method
  {
      this.deliveries--;
  }
  ...
  { 
    User use = (User) other;
    if (this.name.equals(use.getName())&& this.address.equals(use.getAddress())){
      return true;
    }return false;
  }
}
